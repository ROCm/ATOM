...
see the [AgentX benchmark recipe](DeepSeek-V4.1-Flash-Agentic.md). Those runs
use synthetic AL=3.51 and do not establish generation quality.
...
| TP2 no EP | GPU benchmark completed at level 3 FULL; see the [AgentX recipe](DeepSeek-V4.1-Flash-Agentic.md) for synthetic-acceptance scope |
