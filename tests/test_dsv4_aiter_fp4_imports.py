...
# EMPTY on purpose: the FP4 indexer scores through the OPUS kernels
# (`aiter.ops.opus.pa_mqa_logits_opus`), and the FlyDSL `pa_mqa_logits_fp4*`
# family has no callers left. This guard now asserts that nothing reaches back
# for it -- reintroducing a FlyDSL FP4 import means adding it here alongside the
# caller, and saying why the OPUS path did not suffice.
CURRENT_MODULES = set()
