#!/usr/bin/env python3
"""vLLM-ATOM-specific regression summary built on top of shared summarize helpers."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Print only the vLLM-ATOM regression report without the full results table"
    )
    parser.add_argument(
        "--result-dir",
        required=True,
