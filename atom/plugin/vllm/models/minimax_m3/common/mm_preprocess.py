...
try:
    ...
    from atom.plugin.vllm.register import MiniMaxM3Config
...
try:
    ...
    MIN_SHORT_SIDE_PIXEL = 28

    class MiniMaxVLProcessor:  # type: ignore[no-redef]
        pass

    class MiniMaxM3VLImageProcessor:  # type: ignore[no-redef]
        pass

    class MiniMaxM3VLVideoProcessor:  # type: ignore[no-redef]
        pass

    def smart_resize(*args, **kwargs):
        raise RuntimeError("MiniMax-M3 multimodal processor is unavailable.")
