...
from atom.plugin.vllm.models.minimax_m3.common.ops.sparse_attn import SPARSE_BLOCK_SIZE
...
if current_platform.is_rocm():
    from atom.plugin.vllm.models.minimax_m3.amd.ops.sparse_attn import (
        minimax_m3_sparse_attn,
        minimax_m3_sparse_attn_decode,
    )
else:
    from atom.plugin.vllm.models.minimax_m3.common.ops.sparse_attn import (
        minimax_m3_sparse_attn,
        minimax_m3_sparse_attn_decode,
    )
...
def select_main_impl_cls(
    *,
    ...
    if use_msa:
        from atom.plugin.vllm.models.minimax_m3.nvidia.sparse_attention_msa import (
