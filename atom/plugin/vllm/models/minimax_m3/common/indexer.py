...
if current_platform.is_rocm():
    from atom.plugin.vllm.models.minimax_m3.amd.ops.index_topk import (
        minimax_m3_index_decode,
        minimax_m3_index_score,
        minimax_m3_index_topk,
    )
else:
    from atom.plugin.vllm.models.minimax_m3.common.ops.index_topk import (
        minimax_m3_index_decode,
        minimax_m3_index_score,
        minimax_m3_index_topk,
    )
...
def select_indexer_impl_cls(
    *,
    ...
    if use_msa:
        ...
        from atom.plugin.vllm.models.minimax_m3.nvidia.indexer_msa import (
