    ...
    def _do_load_req(self, req: LMCacheReqMeta) -> None:
        ...
        if self._profile_enabled():
            logger.info(
                ...
                self._profile_transfer_stat(transfer_stats, "pack_ms"),
                self._profile_transfer_stat(transfer_stats, "copy_ms"),
                self._profile_transfer_stat(transfer_stats, "sync_ms"),
                self._profile_transfer_stat(transfer_stats, "transfer_ms"),
                self._profile_transfer_stat(transfer_stats, "effective_gbps"),
                retrieve_ms,
                total_ms,
            )
