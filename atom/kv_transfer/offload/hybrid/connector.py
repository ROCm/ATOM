...
* **ATOM-owned PAGE layout** — LMCache owns token chunks and storage while
  :class:`ATOMPageRegionCodec` gathers/scatters DSV4 ``block_regions`` in
  page-major order through the shared raw-block GPU connector.
...
class HybridOffloadConnector(OffloadWorkerMixin, KVConnectorBase):
    ...
    def __init__(self, config) -> None:
        ...
        self._engine = None
        self._codec: BlockByteCodec | None = None
