#!/usr/bin/env bash
#SBATCH --job-name=ds-fp4-atom-1p-tp4-2d-tp8
...
#   sbatch ds_fp4_1p_tp4_2d_tp8_atom_slurm.sh
...
LOG_ROOT="${LOG_ROOT:-/it-share/yajizhan/slurm_logs/$(date +%m%d)_ds_fp4_atom_1p_tp4_2d_tp8_${SLURM_JOB_ID}}"
...
# Two --decode flags for the two decode instances.
