...
#SBATCH --output=/it-share/yajizhan/slurm_logs/ds_v4_1p_tp8_1d_tp8_atom_tp-%j.out
#SBATCH --error=/it-share/yajizhan/slurm_logs/ds_v4_1p_tp8_1d_tp8_atom_tp-%j.err
#
...
LOG_ROOT="${LOG_ROOT:-/it-share/yajizhan/slurm_logs/$(date +%m%d)_ds_v4_1p_tp8_1d_tp8_atom_tp_${SLURM_JOB_ID}}"
...
RUN_TAG="$(date +%Y%m%d%H%M%S)_gsm8k_v4_1p1d_tp"
mkdir -p "${RESULT_DIR}"
