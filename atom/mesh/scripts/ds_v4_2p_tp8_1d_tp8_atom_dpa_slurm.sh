...
#SBATCH --output=/it-share/yajizhan/slurm_logs/ds_v4_2p_tp8_1d_tp8_atom_dpa-%j.out
#SBATCH --error=/it-share/yajizhan/slurm_logs/ds_v4_2p_tp8_1d_tp8_atom_dpa-%j.err
#
...
LOG_ROOT="${LOG_ROOT:-/it-share/yajizhan/slurm_logs/$(date +%m%d)_ds_v4_2p_tp8_1d_tp8_atom_dpa_${SLURM_JOB_ID}}"
...
RUN_TAG="$(date +%Y%m%d%H%M%S)_gsm8k_v4_2p1d_dpa"
mkdir -p "${RESULT_DIR}"
