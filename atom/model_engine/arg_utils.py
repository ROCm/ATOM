...
class EngineArgs:
    ...
    def add_cli_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        parser.add_argument(
            ...
            "so the measured accept length converges to this value. "
            "By default only rejection sampling is overridden; set "
            "ATOM_SPEC_DECODE_SYNTHETIC_FORWARD=1 to use one fixed fake token "
            "throughout target/draft decoding. "
            "AL counts the target's own guaranteed "
