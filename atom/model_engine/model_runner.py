...
class ModelRunner:
    ...
    @with_eplb_forward_monitor
    def _hisparse_token_phys_slots(self, block_table, positions):
    ...
    def _hisparse_stage_and_sync(self, batch: ScheduledBatch) -> None:
        ...
        """
        coord = getattr(self, "hisparse_coordinator", None)
        ...
        for i, rid in enumerate(req_ids):
            ...
            phys = self._hisparse_token_phys_slots(
    ...
    def forward(self, batch: ScheduledBatch) -> ScheduledBatchOutput:
        ...
        self._hisparse_stage_and_sync(batch)
        (
            input_ids,
            temperatures,
            top_ks,
