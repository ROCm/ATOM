...
class Sequence:
    ...
    def __init__(
        ...
        # (`StateSlotPool.checkpoint`). The copy needs a forward to issue it, so
        # the intent outlives the step that formed it; `StateSlotPool.take_copies`
        # turns it into a destination slot and a copy pair when the next batch
        # is built.
        ...
        # `StateSlotPool.mark_speculative` says what the distinction buys.
