...
class Sequence:
    ...
    def __init__(
        ...
        # Compressed-prefix hash hit (blocks) BEFORE the SWA bounded_hit gate,
        # recorded by BlockManager.can_allocate. The gap against the admitted
        # num_cached_blocks is the reuse lost to a missing SWA tail (vs lost to
        # compressed eviction). See CacheStats.
