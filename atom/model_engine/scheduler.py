    ...
    def schedule(self) -> tuple[ScheduledBatch, dict[int, Sequence]]:
        ...
        while (
            ...
            if needs_remote_load:
                ...
                self.block_manager.state_pool.materialize_swa_window(
        ...
        if num_seqs_prefill > 0:
            ...
            if self.block_manager.swa_enabled:
                for seq, chunk in zip(scheduled_seqs.values(), num_scheduled_tokens):
                    self.block_manager.state_pool.ensure_swa_for_tokens(
    ...
    def postprocess(
        ...
        if batch is not None:
            ...
            for i, req_id in enumerate(batch.req_ids):
                ...
                self.block_manager.state_pool.free_swa_after_prefill_chunk(seq)
