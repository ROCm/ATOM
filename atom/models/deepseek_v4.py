...
class DeepseekV4ForCausalLM(nn.Module):
    ...
    def __init__(self, config: Config, prefix: str = "") -> None:
        ...
        #
        # Reading the built modules' use_all2all_kernels subsumes the branch's
        # earlier `ATOM_DISABLE_MORI_ALL2ALL or not _has_module("mori")` test:
        # that flag now feeds selected_all2all_backend, so the bypass shows up
        # here without this file having to know the env var exists.
