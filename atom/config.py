...
class Config:
    ...
    # Pool.STATE class. The PAGE-backed prompt-end placement is controlled
    # independently by ATOM_ENABLE_PREFILL_END_CHECKPOINT. 0 disables only the
    # interval/demand ladder. Must be a multiple of the prefix-cache hash block
    # size. See BlockManager.checkpointers_at.
