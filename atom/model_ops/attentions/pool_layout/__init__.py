...
One topic across six modules -- how many entries a byte budget buys
...
where those bytes are put (`entry_arena`), and how one entry's run is
...
Nothing is re-exported here: a convenience import would pull all six in
