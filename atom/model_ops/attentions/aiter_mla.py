...
class AiterMLAMetadataBuilder(CommonAttentionBuilder):
    ...
    def prepare_decode(
        ...
        # async overlap.
        # Disabled by the "overlap enabled" commit, which is measuring whether
        # the prep_stream barrier really costs more than the overlap buys under
        # rapidserve. Restore by dropping the `False and`.
        serial_prep = False and self.model_runner.config.enable_rapidserve
        ctx = {}
