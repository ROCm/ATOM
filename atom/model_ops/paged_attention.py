...
class PagedAttention(BaseAttention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Arch-portable aiter triton path (replaces the HIP-prebuilt
        # torch.ops.aiter.unified_attention_with_output_base call -- that op
        # is unavailable on gfx1201 and would need a separate dispatch).
