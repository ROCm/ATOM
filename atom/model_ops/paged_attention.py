...
class Attention(BaseAttention):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.output_width = (
            _mla_output_width(self.impl, atom_config.hf_config.hidden_size)
            if self.use_mla
            else None
        )
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.use_mla:
            output_shape[-1] = self.output_width
        output = torch.empty(output_shape, dtype=self.output_dtype, device=query.device)
