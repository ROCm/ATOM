...
class RMSNorm(nn.Module):
    def __init__(
        ...
        # The fused AITER rmsnorm+quant kernel emits only 32- or 128-element
        # groups; a per_1x128 spec with a finer grid (V4.1-Flash 32x32 ue8m0)
        # has to be quantized by the consuming Linear instead.
        if self.use_fused_quant and layer_quant_config.has_fine_block_scale:
