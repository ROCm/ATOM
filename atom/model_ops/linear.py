...
class LinearBase(nn.Module):
    ...
    def __init__(
        ...
        # print("quant_type:", quant_type, "params_dtype:", params_dtype, flush=True)
    ...
    def weight_loader_process(
        ...
        #     param = param.view(torch.uint8)
        #     param.data.copy_(post_process_func(loaded_weight).view(torch.uint8))
    ...
    def weight_loader(self, param: nn.Parameter, loaded_weight: torch.Tensor):
        ...
        print("param:", param.names(), flush=True)
