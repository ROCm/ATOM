...
from atom.utils.graph_marker import graph_marker, is_graph_marker_enabled
...
def _graph_marker_first_tensor(obj, name: str):
    """Apply graph_marker to the first Tensor found in a nested structure.

    This intentionally emits only ONE marker op per call, even if `obj`
    contains multiple tensors (e.g. tuple of (hidden_states, residual)).
    """
