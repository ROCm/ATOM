...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    #
    # NOTE (merge): main grew ATOM_DISABLE_MORI_EP for the same effect, plus a
    # `--moe-all2all-backend none` CLI arg. Both land in
    # FusedMoEParallelConfig.selected_all2all_backend; this one is kept as a
    # second spelling so existing rapidserve launch commands keep working.
    # Collapsing the two into ATOM_DISABLE_MORI_EP is a reasonable follow-up.
