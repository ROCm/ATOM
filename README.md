...
- **[2026/05]** [Dissecting DeepSeek V4 Compressor](https://rocm.github.io/ATOM/docs/dissecting_dsv4_compressor/) — interactive animation visualizing how the CSA/HCA compressor state cache works (overlap mechanism, prefill vs decode, bulk compression vs sequential accumulation).
