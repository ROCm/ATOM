...
- [DeepSeek-V4.1-Flash AgentX](recipes/DeepSeek-V4.1-Flash-Agentic.md) — TP2/TP4, no EP, DSpark5, synthetic AL=3.51 benchmark commands and measured operating points
