...
- **[2026/06]** **Experimental gfx1201 (RDNA4 / Navi 48) support** — run on AMD Radeon RX 9070 / RX 9070 XT and Radeon AI PRO R9700 via the all-triton attention path (`ATOM_USE_UNIFIED_ATTN=1`; no prebuilt HIP kernels required). See the [Qwen3-8B-FP8](recipes/Qwen3-8B-FP8.md) and [Ministral-3-8B](recipes/Ministral-3-8B.md) recipes.
