...
| **ATOM_V4_FLYDSL_FP8_DECODE** | bool | 1 (true) | On gfx950, use graph-safe FlyDSL native-FP8 decode for the qualified H128/q7 HCA B6 and CSA B5-B32 shapes. Set `0` for matched Triton comparisons. `ATOM_USE_TRITON_ATTN=0` still forces AITER. |
